...
@section('content')
    ...
    <div class="col-md-10 offset-md-2 mt-5 main cuerpo-dos">
        <h1 class="lines-effect">Editar Cliente</h1>
        <div class="card mt-2">
            <div class="card-header text-white bg-dark">{{ __('Especifique la información del cliente a editar.') }}</div>
            <div class="card-body">
                ...
                <div class="form-group">
                        <a href="{{ route('users.index') }}" class="btn btn-primary">Editar Cliente</a>
