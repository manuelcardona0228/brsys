...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="row">
        ...
        <div class="card" id="card-accordion">
                ...
                <div class="card-body">
                    <ul class="botones">
                        <a href="{{ route('typeUsers.create') }}"><li>Agregar tipo de usuario</li></a>
                        <a href="{{ route('typeUsers.index') }}"><li>Ver tipo de usuario</li></a>
                    </ul>
                </div>
                </div>
            </div>
        ...
        <div class="card" id="card-accordion">
            ...
            <div class="card" id="card-accordion">
                ...
                <div class="card-body">
                    <ul class="botones">
                        <a href="{{ route('cities.create') }}"><li>Agregar Ciudades</li></a>
        ...
        <div class="col-md-10 offset-md-2 mt-5 main">
            <h2 class="h2-carrusel mt-2" style="text-align: center;">Promociones Administrador Barberias</h2>
            <div class="card">
